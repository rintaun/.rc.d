# Generated by Powerlevel10k configuration wizard on 2020-05-15 at 10:26 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_AT_COMMIT_ICON=''
  typeset -g POWERLEVEL9K_VCS_PULL_BEHIND_ICON=' '
  typeset -g POWERLEVEL9K_VCS_PUSH_BEHIND_ICON=' '
  typeset -g POWERLEVEL9K_VCS_PULL_AHEAD_ICON=' '
  ...
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_UNKNOWN_ICON=''
  ...
  function my_git_formatter() {
    ...
    [[ -z $where ]] && res+="${meta}${(g::)POWERLEVEL9K_VCS_AT_COMMIT_ICON}${clean}${VCS_STATUS_COMMIT[1,8]}"
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_PULL_BEHIND_ICON}${VCS_STATUS_COMMITS_BEHIND}"
    # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
    (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_PULL_AHEAD_ICON}${VCS_STATUS_COMMITS_AHEAD}"
    # ⇠42 if behind the push remote.
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_PUSH_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_PUSH_AHEAD_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
    ...
    # in this case.
    (( VCS_STATUS_HAS_UNSTAGED == -1 )) && res+=" ${modified}${(g::)POWERLEVEL9K_VCS_UNSTAGED_UNKNOWN_ICON}"
